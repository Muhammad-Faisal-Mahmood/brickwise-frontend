    ...
    <section className="">
      <div className="mx-auto  flex flex-col lg:flex-row items-center justify-between gap-8">
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left flex-1">
          ...
          {/* Subheading & CTA */}
          <p className="order-3 lg:order-none mt-5 md:mt-0 text-lg leading-6 text-primary-subHeading dark:text-dark-subHeading mb-6">
        ...
        <div className="hidden lg:flex flex-1 max-w-md w-full">
          <img
            src="https://plus.unsplash.com/premium_photo-1678208881503-d081cbedc095?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8cHJvcGVydHklMjBkZWFsZXJ8ZW58MHx8MHx8fDA%3D"
            alt="Property Dealer"
